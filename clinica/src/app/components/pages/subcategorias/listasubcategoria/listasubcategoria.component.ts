...
@Component({
    selector: 'app-listasubcategoria',
    imports: [CommonModule, RouterModule, FormsModule],
    templateUrl: './listasubcategoria.component.html',
    styleUrl: './listasubcategoria.component.css'
})
export class listaSubcategoriaComponent {
